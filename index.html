  ...
  <body>
    ...
    <section id="profile">
      <div class="section__pic-container">
        <img src="./asset/OLASUNKANMI_HEADSHOT.png" alt="Olasunkanmi Aremu profile picture" />
      </div>
    ...
    <section id="about">
      ...
      <div class="section-container">
        <div class="section__pic-container">
          <img
            src="./asset/OLASUNKANMI_HEADSHOT.png"
            alt="Profile picture"
            class="about-pic"
          />
        </div>
      ...
      <div class="experience-details-container">
        <div class="about-containers">
          <div class="details-container color-container">
            <div class="article-container">
              <img
                src="./asset/preambule_money_pro_android.jpg"
                alt="Project 1"
                class="project-img"
              />
            </div>
